...
def summarize_metrics_comparison(
    ...
    """
    Create comparison table for specified metrics across models.

    Returns:
        {"accuracy": [v1, v2, ...], "latency_ms": [...], ...} with model order preserved
    """
    if key_metrics is None:
        key_metrics = ["test_accuracy", "test_top3_accuracy", "throughput_ratio", "inference_latency_ms"]
    ...
    for model_name, metrics in all_metrics.items():
        for metric in key_metrics:
            ...
            if '.' in metric:
                ...
                comparison[metric].append(metrics.get(metric, None))
